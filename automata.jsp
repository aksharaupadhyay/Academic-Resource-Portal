...
<td>
    ...
    <th  class ="th1" style="background:#313131; color:white;"><p><h3><center>Midsem Exam paper</center></h3></p></th>
        ...
        resultSet=statement.executeQuery("select * from subject where type='midsem' and SubjectName='Automata Theory'");
...
<td>
    ...
    <table  class ="table2" style="width:100%" style="hight:100%" border=" 2px" >
        ...
        connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
        statement=connection.createStatement();
        resultSet=statement.executeQuery("select * from subject where type='endsem' and SubjectName='Automata Theory'");
        while(resultSet.next())
            {
             %><tr bordercolor="red" onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
         <td style="color:#313131;font-size:20px;height:50px;width:200px"><center><b><%=resultSet.getString("course")%> - <%=resultSet.getString("year")%></b>
...
<td>
    ...
    <table  class ="table2" style="width:100%" style="hight:100%" border=" 2px" >
        ...
        connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
        statement=connection.createStatement();
        resultSet=statement.executeQuery("select * from subject where type='Tutorial' and SubjectName='Automata Theory'");
        while(resultSet.next())
            {
             %><tr bordercolor="red" onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
         <td style="color:#313131;font-size:20px;height:50px;width:200px"><center><b><%=resultSet.getString("course")%> - <%=resultSet.getString("year")%></b>
...
<td>
    ...
    <table  class ="table2" style="width:100%" style="hight:100%" border=" 2px" >
        ...
        connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
        statement=connection.createStatement();
        resultSet=statement.executeQuery("select * from subject where type='Quiz' and SubjectName='Automata Theory'");
        while(resultSet.next())
            {
             %><tr bordercolor="red" onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
         <td style="color:#313131;font-size:20px;height:50px;width:200px"><center><b><%=resultSet.getString("course")%> - <%=resultSet.getString("year")%></b>
